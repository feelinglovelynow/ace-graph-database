...
/** @typedef { 'Empty' | 'GetSchema' | 'AddToSchema' | 'GetBackup' | 'LoadBackup' | 'AddNodeToGraph' | 'AddRelationshipToGraph' | 'UpdateGraphNode' | 'UpdateGraphRelationship' | 'UpsertGraphNode' | 'UpsertGraphRelationship' | 'QueryByNode' | 'QueryByRelationship' | 'InstallPlugin' | 'UninstallPlugin' | 'DataDeleteNodes' | 'DataDeleteRelationships' | 'DataDeleteNodeProps' | 'DataDeleteRelationshipProps' | 'SchemaAndDataDeleteNodes' | 'SchemaAndDataDeleteRelationships' | 'SchemaAndDataDeleteNodeProps' | 'SchemaAndDataDeleteRelationshipProps' | 'SchemaAndDataUpdateNameOfNodes' | 'SchemaAndDataUpdateNameOfRelationships' | 'SchemaAndDataUpdateNameOfNodeProps' | 'SchemaAndDataUpdateNameOfRelationshipProps' } idsAce */
export const idsAce = {
  Empty: /** @type { 'Empty' } */ ('Empty'),
  GetSchema: /** @type { 'GetSchema' } */ ('GetSchema'),
  AddToSchema: /** @type { 'AddToSchema' } */ ('AddToSchema'),
  GetBackup: /** @type { 'GetBackup' } */ ('GetBackup'),
  LoadBackup: /** @type { 'LoadBackup' } */ ('LoadBackup'),
  AddNodeToGraph: /** @type { 'AddNodeToGraph' } */ ('AddNodeToGraph'),
  AddRelationshipToGraph: /** @type { 'AddRelationshipToGraph' } */ ('AddRelationshipToGraph'),
  UpdateGraphNode: /** @type { 'UpdateGraphNode' } */ ('UpdateGraphNode'),
  UpdateGraphRelationship: /** @type { 'UpdateGraphRelationship' } */ ('UpdateGraphRelationship'),
  UpsertGraphNode: /** @type { 'UpsertGraphNode' } */ ('UpsertGraphNode'),
  UpsertGraphRelationship: /** @type { 'UpsertGraphRelationship' } */ ('UpsertGraphRelationship'),
  QueryByNode: /** @type { 'QueryByNode' } */ ('QueryByNode'),
  QueryByRelationship: /** @type { 'QueryByRelationship' } */ ('QueryByRelationship'),
  InstallPlugin: /** @type { 'InstallPlugin' } */ ('InstallPlugin'),
  UninstallPlugin: /** @type { 'UninstallPlugin' } */ ('UninstallPlugin'),
  DataDeleteNodes: /** @type { 'DataDeleteNodes' } */ ('DataDeleteNodes'),
  DataDeleteRelationships: /** @type { 'DataDeleteRelationships' } */ ('DataDeleteRelationships'),
  DataDeleteNodeProps: /** @type { 'DataDeleteNodeProps' } */ ('DataDeleteNodeProps'),
  DataDeleteRelationshipProps: /** @type { 'DataDeleteRelationshipProps' } */ ('DataDeleteRelationshipProps'),
  SchemaAndDataDeleteNodes: /** @type { 'SchemaAndDataDeleteNodes' } */ ('SchemaAndDataDeleteNodes'),
  SchemaAndDataDeleteRelationships: /** @type { 'SchemaAndDataDeleteRelationships' } */ ('SchemaAndDataDeleteRelationships'),
  SchemaAndDataDeleteNodeProps: /** @type { 'SchemaAndDataDeleteNodeProps' } */ ('SchemaAndDataDeleteNodeProps'),
  SchemaAndDataDeleteRelationshipProps: /** @type { 'SchemaAndDataDeleteRelationshipProps' } */ ('SchemaAndDataDeleteRelationshipProps'),
  SchemaAndDataUpdateNameOfNodes: /** @type { 'SchemaAndDataUpdateNameOfNodes' } */ ('SchemaAndDataUpdateNameOfNodes'),
  SchemaAndDataUpdateNameOfRelationships: /** @type { 'SchemaAndDataUpdateNameOfRelationships' } */ ('SchemaAndDataUpdateNameOfRelationships'),
  SchemaAndDataUpdateNameOfNodeProps: /** @type { 'SchemaAndDataUpdateNameOfNodeProps' } */ ('SchemaAndDataUpdateNameOfNodeProps'),
  SchemaAndDataUpdateNameOfRelationshipProps: /** @type { 'SchemaAndDataUpdateNameOfRelationshipProps' } */ ('SchemaAndDataUpdateNameOfRelationshipProps'),
}
