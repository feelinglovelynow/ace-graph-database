...
const response = await ace({
  ...
  request: [
    ...
    { id: 'AddGraphNode', node: 'Actor', props: { uid: '_:Keanu', name: 'Keanu Reeves' } },
    { id: 'AddGraphNode', node: 'Actor', props: { uid: '_:Laurence', name: 'Laurence Fishburne' } },
    { id: 'AddGraphNode', node: 'Actor', props: { uid: '_:Carrie', name: 'Carrie-Anne Moss' } },
